            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
              ...
              <div className="md:col-span-2 flex flex-col gap-8">
                ...
                <div 
                  ...
                  data-aos-delay="300"
                >
                  <h3 className="text-3xl font-bold mb-4 text-center">Visi</h3>
                ...
                <div 
                  ...
                  data-aos-delay="450"
                >
                  <h3 className="text-3xl font-bold mb-4 text-center">Misi</h3>
                  <ul className="list-decimal list-outside text-gray-200 ml-6 space-y-3 text-lg text-left max-w-2xl">
